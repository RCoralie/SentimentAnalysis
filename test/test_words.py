...
from ..utils import PreprocessWord
...
class WordsTest(unittest.TestCase):
    ...
    def test_wordIntoGlove(self):
        ...
        word = ["scat"]
        resultArray, expectedSize = PreprocessWord.wordsToGlove(word, gloveDic)
    ...
    def test_twoWordsIntoGlove(self):
        ...
        gloveDic = GloveDict.loadGloveDicFromFile()
        words = ["sugar","daddy"]
        resultArray, expectedSize = PreprocessWord.wordsToGlove(words, gloveDic)
        size = resultArray.shape[1]
    ...
    def test_meanTwoWordsIntoGlove(self):
        ...
        resultArray, expectedSize = PreprocessWord.wordsToGlove(words, gloveDic)
        resultMean = PreprocessWord.meanWords(resultArray, expectedSize)
